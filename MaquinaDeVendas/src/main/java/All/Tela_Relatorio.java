...
public class Tela_Relatorio extends javax.swing.JFrame {
    ...
    public Tela_Relatorio(Relatorio_Transacoes relatorio) {
        initComponents();
        this.pos = 0;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Valor da Operacao:");

        jLabel7.setText("Codigo de Operacao:");
        ...
        jLabel10.setText("999 - Operacoes do Cofre");

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("101, 102, 103... - Codigo de Produtos Vendidos");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // BOTAO PROXIMO
        this.relatorio.proximo_relatorio();
        this.set_tela();
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // BOTAO ANTERIOR
        this.relatorio.anterior_relatorio();
        this.set_tela();
    ...
    public void set_tela(){
        this.jLabel1.setText(this.relatorio.get_tipo_operacao());
        this.jLabel4.setText(this.relatorio.get_tipo());
        this.jLabel5.setText(this.relatorio.get_data());
        this.jLabel8.setText(this.relatorio.get_vlr_pdt());
        this.jLabel9.setText(this.relatorio.get_cdg_pdt());
    }
